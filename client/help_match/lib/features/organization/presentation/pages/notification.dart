          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  // Replace child widget with this to avoid overflow
                  child: Padding(
                        ...
                        ? ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              if (applicants[index].status == "pending") {
                                // print(
                                //     "name : ${applicants[index].name} userId: ${applicants[index].volunteerId}");
                                return ApplicantCard(
                                    name: applicants[index].name,
                                    jobId: applicants[index].jobId,
                                    userId: applicants[index].volunteerId);
                              }
                              return const SizedBox(); // Handle cases when status isn't "pending"
                            },
                            separatorBuilder:
